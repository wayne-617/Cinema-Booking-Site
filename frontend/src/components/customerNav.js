  ...
  return (
      <header className="mainHeader">
        <div className="headerDiv">
          <NavLink to="/customer" className="logoDiv">
            <img src={logo} alt="Logo" className="logo" />
            <h1 className="logoText">Absolute Cinema</h1>
          </NavLink>
          <div className="navBar">
            <a href="/customer/movies" className="buttons">
              Movies
            </a>
            <a href="/customer/showtimes" className="buttons">
              Showtimes
            </a>
            <a href="/customer/theaters" className="buttons">
              Theaters
            </a>
            <a href="/customer" className="buttons">
              About
            </a>
          </div>
          ...
          <div className="searchBar">
            <form
              onSubmit={(e) => {
                e.preventDefault();
                if (query.trim() !== "") {
                  navigate(`/customer/movies?search=${encodeURIComponent(query.trim())}`);
                  setResults([]);
                }
              }}
            >
          ...
          <div className="navDiv">
            ...
            <a href="/editProfilePage" className="buttons">
              Edit Profile
            </a>
          </div>
        </div>
